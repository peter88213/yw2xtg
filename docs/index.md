...
[Download the latest release (version 0.7.1)](https://raw.githubusercontent.com/peter88213/yw2xtg/master/dist/yw2xtg_v0.7.1.zip)

- Unzip the downloaded zipfile "yw2xtg_v0.7.1.zip" into a new folder and open "README.md" for usage instructions.
